...
public let post1 = Post(title: "Game Drive",
...
public let post2 = Post(title: "Google Growth Lab",
...
public let post3 = Post(title: "Games Festival",
...
public let post4 = Post(title: "Google Doodle",
